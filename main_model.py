...
class CSDI_base(nn.Module):
    def __init__(self, target_dim, config, device,ratio = 0.7):
        ...
        self.is_conditional = config["model"]["is_conditional"]
        self.target_strategy = config["model"]["target_strategy"]
        print("conditional is")
        print(self.is_conditional)
        ...
        input_dim = 1 if self.is_conditional == True else 2
