...
def train(
    ...
    AUC_ROC, BEST_Fc1, BEST_AUC_F1_K = evaluate(model, args, test_loader1, test_loader2, nsample=20, scaler=1, mean_scaler=0, foldername="",epoch_number = "",name="")
...
def evaluate(model, args, test_loader1, test_loader2, nsample=20, scaler=1, mean_scaler=0, foldername="",epoch_number = "",name=""):
    ...
    with torch.no_grad():
        ...
        gt = np.load("/content/drive/MyDrive/data/dataset/" + args.dataset + '/' + args.dataset + '_test_label.npy')
